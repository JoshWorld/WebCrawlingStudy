    ...
    while True:
        ...
        for news_link in news_list:
            if news_link.text == "네이버뉴스":
                ...
                i = i + 1
                print(naver_news_links)
                if i == int(page_count):
                    return naver_news_links
        j = j * 10


def get_comments(news_link):
    comment_count = 0
